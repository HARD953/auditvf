...
const taxBodyCommune = (data) => {
  ...
  const cols = [
    ...
    { field: "taxDistrict", header: "Tax District", body: taxBodyDistrict },
    { field: "taxRegion", header: "Tax Région", body: taxBodyRegion },
    { field: "taxCommune", header: "Tax Commune", body: taxBodyCommune },
